...
from .tool import search_youtube
from . import prompt
import os
...
drills_agent = Agent(
    ...
    name='drills_agent',
    description='A drill recommender agent that recommends basketball drills based of the user weakness.',
    tools=[search_youtube,search_memory],
    after_agent_callback= auto_save_to_memory_callback,
    instruction=prompt.DRILLS_PROMPT
    )